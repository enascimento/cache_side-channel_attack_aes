...
int main(int argc, char **argv)
{
	...
	if(argc != 8) {
		printf("USAGE : ./attacker <limit plain text count> <repeat count for a plaintext> <cpu cycle threshold> <offset te0> <offset te1> <offset te2> <offset te3>\n");
		printf("EXAMPLE : ./attacker 1000 1 200 0010dca8 0010e0a8 0010e4a8 0010d8a8\n");
		return 0;
	}
